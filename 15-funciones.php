...
include 'includes/header.php'; //Si no encuentra el archivo se ejecuta normal
require 'includes/header.php'; //Si no encuentra el archivo no se ejecuta
require_once 'includes/header.php'; //Solo se puede ejecutar una sola vez
